...
object Message {
	...
	case class QuitMessage(user : User, message : Option[String]) extends Message with ScopedBroadcastMessage with ServerMessage with UserMessage
	...
	case class ServiceRequest(channel : Channel, user : User, data : String) extends Message with ChannelMessage
